...
- .NET: (`nuget/CometTextel.NET`): [`nuget/CometTextel.NET/CometTextel.NET/README.md`](https://github.com/jiowcl/CometTextel/blob/main/nuget/CometTextel.NET/README.md)
