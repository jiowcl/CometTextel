...
Optional language samples (thin FFI, same shared library; not built in CI): [`sdk/python/`](sdk/python) (ctypes, PDU), [`sdk/purebasic/`](sdk/purebasic) (PDU), [`sdk/freebasic/`](sdk/freebasic) (PDU).  
